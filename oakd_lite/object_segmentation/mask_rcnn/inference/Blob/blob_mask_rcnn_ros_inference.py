...
NN_PATH = "./weight/maskrcnn_resnet50_300_300_openvino_2021.4_6shave.blob"
...
pm = PipelineManager()
pm.createColorCam(previewSize=NN_SHAPE, res=dai.ColorCameraProperties.SensorResolution.THE_1080_P, fullFov=False, xout=False)
...
def show_boxes_and_regions(frame, boxes, masks):
    for i, box in enumerate(boxes):
        ...
        cls = int(box[1])
        prob = box[2]
        print("cls: {}, score: {}".format(cls,prob))
        if prob < THRESHOLD:
            continue
